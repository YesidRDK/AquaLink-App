// ================================================
// Pantalla: Ruta Activa del Conductor
// Muestra el mapa con la ruta hacia el destino
// y gestiona los estados de llegada, espera de
// pago y verificación final de la entrega.
// ================================================
...
export default function DriverRouteScreen({ navigation, route }) {
  ...
  // Estados de la ruta: 1 = En camino, 2 = Llegó (esperando pago), 3 = Pago recibido
  ...
  // ==============================================
  // EFECTO: Obtener ubicación GPS inicial
  // ==============================================
  useEffect(() => {
    (async () => {
  ...
  // Simula la espera hasta que el cliente reporta el pago
  // ==============================================
  const handleLlegada = () => {
    setEstadoRuta(2);
    setTimeout(() => {
  ...
  // ==============================================
  // Verificar pago y completar la entrega
  // ==============================================
      ...
      {estadoRuta === 1 ? (
        <>
          ...
          <View style={{ padding: 20, paddingBottom: 50, backgroundColor: '#fff', elevation: 15 }}>
            <Text style={{ textAlign: 'center', color: '#666', marginBottom: 15, fontSize: 13 }}>
              Sigue la línea de color para llegar a tu destino.
            </Text>
            <TouchableOpacity
        ...
        /* Estados 2 y 3: Espera de pago y verificación */
        <View style={{ flex: 1, justifyContent: 'center', padding: 30, backgroundColor: '#fdfdfd' }}>
          <View style={{
            backgroundColor: '#fff', padding: 30, borderRadius: 20, elevation: 5,
            alignItems: 'center', borderWidth: 1,
            borderColor: estadoRuta === 2 ? '#FF9800' : '#34C759'
          }}>
